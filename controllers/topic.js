...
var controller = {
    ...
    getTopics: function (req, res) {
        ...
        // Cargar la libreria de paginaci�n en la clase (MODELO)
        ...
        // Indicar las opciones de paginaci�n
        var options = {
            sort: { date: -1 },
            populate: 'user',
            limit: 5,
    ...
    getTopicsByUser: function (req, res) {
        ...
        // Find con una condici�n de usuarios
        Topic.find({
            user: userId
        })
    ...
    update: function (req, res) {
        ...
        // Recoger el id del topic del la url
        var topicId = req.params.id;
        ...
        if(validate_title && validate_content && validate_lang) {
            ...
            return res.status(200).send({
                message: "La validaci�n de los datos no es correcta"
            });
        }
